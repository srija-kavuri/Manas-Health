...
# Load the dataset
data = pd.read_csv(r'manashealth/mlModel/general_test/general_mental_health_test.csv')
...
general_final_model = RandomForestClassifier(
...
general_final_model.fit(X_train, y_train)
y_pred_final = general_final_model.predict(X_test)
accuracy_final = accuracy_score(y_test, y_pred_final)
print("Final Model Accuracy:", accuracy_final)
joblib.dump(general_final_model, 'general_final_model.joblib')
