...
def predict_severity(user_inputs):
    ...
    model = joblib.load('C:/Users/valli/Desktop/project school/manashealth/mlModel/anxiety/anxiety_final_model.joblib')

    # Load the LabelEncoder used during training
    le = joblib.load('C:/Users/valli/Desktop/project school/manashealth/mlModel/anxiety/label_encoder.joblib')
